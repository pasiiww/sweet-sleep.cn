...
- The old-mechanism progress bar stays full while an unlocked exchange is waiting to be claimed, then starts the next 200-pull segment after that exchange is used.
